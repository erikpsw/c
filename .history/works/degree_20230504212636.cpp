...
int main(){
    ...
    double std=435.8;
    double k1=((d*sin(p*M_PI /180))*1000000);
    cout<<"k=2  "<<k1<<endl;
    cout<<"E:  "<<100*((abs(k1-std))/std)<<endl;
    double k2=(d*sin(p*M_PI /180))*1000000/3;
    cout<<"k=3  "<<(d*sin(p*M_PI /180))/2<<endl;
    cout<<"E:  "<<100*((abs(k2-std))/std)<<endl;
